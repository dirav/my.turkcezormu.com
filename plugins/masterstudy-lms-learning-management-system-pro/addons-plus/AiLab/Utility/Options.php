...
final class Options {
	...
	private function get_options(): array {
		return array(
			...
			'generator' => array(
				'title'   => array(
					'prompt' => 'Create a short SEO-friendly title for this prompt: %s. Must be between 40 and 60 characters, no URLs, no apostrophes.',
					'tokens' => 100,
				),
				'text'    => array(
					'prompt' => 'Create a SEO-friendly text for this prompt: %s. Must be between 40 and 60 words, no URLs, no apostrophes.',
					'tokens' => 500,
				),
				'content' => array(
					'prompt' => 'Create a SEO-friendly content for this prompt: %s. No URLs, no apostrophes, no titles.',
					'tokens' => 1500,
					'tones'  => array(
						'Formal'         => 'Formal',
						'Casual'         => 'Casual',
