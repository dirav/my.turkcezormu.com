				...
				array(
					array(
						...
						'content' => "You are an educational content creator. Create a clear, engaging, and concise title for an assignment.\n"
									. 'Respond with just the title, no additional text or formatting. Generate in language of the prompt.',
					),
					array(
						'role'    => 'user',
						'content' => "Create a title for an assignment about: {$this->prompt}\n"
									. 'Generate in language of the prompt.',
					),
				),
				array(
					'max_results' => 1,
				...
				array(
					...
					array(
						...
						'content' => "Create the main Assignment with these details:\n" .
									...
									"Tone: {$this->tone}\n" .
									"Do not add Title at the beginning of the content. Generate in language of the prompt.\n" .
